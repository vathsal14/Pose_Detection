...
if __name__ == '__main__':
    ...
    parser.add_argument('--image', type=str, default='', help='path to image file. If not specified, camera will be used.')
    ...
    if args.image:
        ...
        while True:
            ...
            humans = e.inference(image, scales=scales)
            elapsed = time.time() - t
            logger.info('inference camera image in %.4f seconds.' % (elapsed))
