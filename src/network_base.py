...
_init_norm = tf.random_normal_initializer(stddev=0.01)
...
class BaseNetwork(object):
    ...
    def make_var(self, name, shape, trainable=True):
        ...
        return tf.compat.v1.get_variable(name, shape, trainable=self.trainable & trainable, initializer=tf.compat.v1.keras.initializers.glorot_uniform())
